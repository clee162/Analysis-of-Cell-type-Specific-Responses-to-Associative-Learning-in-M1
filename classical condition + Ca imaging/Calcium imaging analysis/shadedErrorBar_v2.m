function varargout=shadedErrorBar_v2(x,y,errBar,c,varargin)
% Rob Campbell (2021). raacampbell/shadedErrorBar (https://github.com/raacampbell/shadedErrorBar), GitHub. Retrieved August 3, 2021.
...
params.addParameter('lineProps',{'color', c}, @(x) ischar(x) | iscell(x));
